...
- Lesson 1 → shell basics (echo, date, whoami, ls, shortcuts)
- Lesson 2 → navigation (pwd, cd, ls, cat, less, file)
- Lesson 3 → file management (touch, mkdir, cp, mv, rm, rmdir)
- Lesson 4 → file content tools (head, tail, wc, sort, uniq, grep)
