...
function set_bubu_prompt() {
  ...
  if [[ $EUID -eq 0 ]]; then
	...
	user_color="\[\e[1;33m\]"
  	...
  	# Build PS1
	PS1="\n\[\e[1;35m\]╭─$venv_name[\[\e[1;33m\]$user_color\u\[\e[0m\]\[\e[1;31m\]@\[\e[0m\]\[\e[1;34m\]\h\[\e[0m\]\\[\e[1;35m\]]-[\[\e[1;33m\]\W\[\e[1;35m\]]$git_branch$eza_status\n\[\e[1;35m\]╰─$prompt_symbol \[\e[0m\]"
...
function set_bubu_prompt() {
        ...
        if command -v eza &>/dev/null; then
                local files_count=$(eza -1 | wc -l)
                eza_status=" \[\e[1;35m\] 󰚝  $files_count \[\e[0m\]"
        ...
        # Build PS1
        PS1="\n\[\e[1;34m\]╭─$venv_name\[\e[1;35m\][\[\e[1;33m\]$user_color\u\[\e[0m\]\[\e[1;31m\]💀\[\e[0m\]\[\e[1;34m\]\h\[\e[0m\]\\[\e[1;35m\]]-[\[\e[1;33m\]\W\[\e[1;35m\]]$git_branch$eza_status\n\[\e[1;34m\]╰─$prompt_symbol \[\e[0m\]"
}
PROMPT_COMMAND=set_bubu_prompt
```
