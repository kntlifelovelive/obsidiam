...
🔹 Cloudflared ကို စမ်းစရာအတွက်ပိုမိုလွယ်ကူပါတယ်။
...
- PNG black screen ဖြစ်နေလျှင် ⇒  victim ဖုန်းမှာ **camera permission** မပေးရသေးတာဖြစ်နိုင်တယ်။
...
ခုပဲရှင်းချင်တာတစ်ခုကတော့ `CamPhish` က tool တစ်ခုသာဖြစ်ပြီး၊ **တကယ် Hack လုပ်တတ်ဖို့** အတွက်တော့ network, web, payload knowledge တွေကိုနားလည်ဖို့လိုပါတယ်။ 
